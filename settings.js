...
//   
//_______________________ ┏ Make By Nekellalwayslus ┓ _______________________\\
...
//note service SMTP Gmail Tidak Boleh Send Di Temp Email Kalau mau pakai temp email buat di service lain
...
fromsendemail = process.env.fromsendemail // From Email SMTP *kalau Ga ada custom email kena sama email dengan Email SMTP
sendpwmail = process.env.sendpwmail // Password Email SMTP
domain = 'nekellishere.biz.id'// domain website tanpa http or https
